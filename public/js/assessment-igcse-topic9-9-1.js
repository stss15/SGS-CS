/**
 * Extracted from 9.1_assessment.html on 2025-12-14
 ...
 */
        ...
        // Q1 Data (Structure)
        const q1Defs = [
            { id: '1', text: 'A collection of related records' },
            { id: '2', text: 'A row containing data about one item' },
            { id: '3', text: 'A column containing one specific piece of data' },
            { id: '4', text: 'A unique identifier for a record' },
            { id: '5', text: 'A structured collection of data' }
        ];
        const q1Terms = [
            { id: '1', text: 'Table' },
            { id: '2', text: 'Record' },
        ...
        // Q2 Data (Data Types)
        const q2Items = [
            { id: 't1', text: '"Smith"', correct: 'text' },
            { id: 'i1', text: '25', correct: 'integer' },
            { id: 'r1', text: '15.99', correct: 'real' },
            { id: 'b1', text: 'TRUE', correct: 'boolean' },
            { id: 'd1', text: '12/12/2023', correct: 'date' }
        ];

        // Q3 Data (SQL Structure)
        const q3Steps = [
            { id: 's1', text: 'SELECT FirstName, LastName' },
            { id: 's2', text: 'FROM Students' },
            { id: 's3', text: 'WHERE Age > 15' },
            { id: 's4', text: 'ORDER BY LastName' }
        ];

        // Q4 Data (SQL Logic)
        const q4Options = [
            { value: 'Ford, Honda', correct: true },
            { value: 'Ford, Toyota, Honda', correct: false },
            { value: 'Toyota', correct: false },
            { value: 'Red, Red', correct: false }
        ];
        let q4Selection = null;

        // Q5 Data (SQL Operators)
        const q5Defs = [
            { id: '1', text: 'Not Equal To' },
            { id: '2', text: 'Greater Than or Equal To' },
            { id: '3', text: 'Pattern Search' },
            { id: '4', text: 'Both conditions must be true' },
            { id: '5', text: 'Calculates the total of a field' }
        ];
        const q5Terms = [
            { id: '1', text: '<>' },
            { id: '2', text: '>=' },
        ...
        const questionMeta = [
            { id: 'q1', title: 'Database Structure', type: 'match', correctAnswer: { '1': 'Table', '2': 'Record', '3': 'Field', '4': 'Primary Key', '5': 'Database' } },
            { id: 'q2', title: 'Data Types', type: 'drag', correctAnswer: { text: ['"Smith"'], integer: ['25'], real: ['15.99'], boolean: ['TRUE'], date: ['12/12/2023'] } },
            { id: 'q3', title: 'SQL Structure', type: 'order', correctAnswer: ['Select', 'From', 'Where', 'Order By'] },
            { id: 'q4', title: 'SQL Logic', type: 'mcq', correctAnswer: 'Ford, Honda' },
            { id: 'q5', title: 'SQL Operators', type: 'match', correctAnswer: { '1': '<>', '2': '>=', '3': 'LIKE', '4': 'AND', '5': 'SUM' } }
        ];
        ...
        function checkAnswers() {
            ...
            if (!checkDragQuestion('q2', 'text', 'integer', 'real', 'boolean', 'date')) allCorrect = false;
            if (!checkOrderQuestion('q3', ['s1', 's2', 's3', 's4'])) allCorrect = false;
            if (!checkMCQQuestion('q4', q4Selection, q4Options)) allCorrect = false;
            if (!checkMatchQuestion('q5', 5)) allCorrect = false;
