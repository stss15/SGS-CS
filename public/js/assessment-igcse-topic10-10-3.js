/**
 * Extracted from 10.3_assessment.html on 2025-12-14
 ...
 */
        ...
        let timeTakenStr = "";
        let teacherName = "";
        const testName = "10.3 Logic Circuits & Expressions";
        ...
        // Q1 Data (Problem Statement)
        const q1Options = [
            { value: '(A AND NOT B) OR C', correct: true },
            { value: '(A OR NOT B) AND C', correct: false },
            { value: 'A AND (NOT B OR C)', correct: false },
            { value: '(A AND B) OR C', correct: false }
        ];
        let q1Selection = null;

        // Q2 Data (Logic Steps)
        const q2Steps = [
            { id: 's1', text: 'Evaluate (A OR B): 0 OR 1 = 1' },
            { id: 's2', text: 'Evaluate C: 1' },
            { id: 's3', text: 'Evaluate (Result1 AND C): 1 AND 1' },
            { id: 's4', text: 'Final Output: 1' }
        ];

        // Q3 Data (Circuit Structure)
        const q3Defs = [
            { id: '1', text: 'Two inputs to AND, result OR\'d with C' },
            { id: '2', text: 'B and C to OR, result AND\'d with A' },
            { id: '3', text: 'NAND gate equivalent' },
            { id: '4', text: 'NOR gate equivalent' }
        ];
        const q3Terms = [
            { id: '1', text: '(A AND B) OR C' },
            { id: '2', text: 'A AND (B OR C)' },
            { id: '3', text: 'NOT (A AND B)' },
            { id: '4', text: 'NOT (A OR B)' }
        ];

        // Q4 Data (Intermediate Values)
        const q4Options = [
        ...
        // Q5 Data (Logic Construction)
        const q5Items = [
            { id: 'i1', text: 'NOT A', correct: 'expression' },
            { id: 'i2', text: 'AND', correct: 'expression' },
            { id: 'i3', text: 'B', correct: 'expression' }
        ];

        const questionMeta = [
            { id: 'q1', title: 'Problem Statement to Logic', type: 'mcq', correctAnswer: '(A AND NOT B) OR C' },
            { id: 'q2', title: 'Logic to Truth Table', type: 'order', correctAnswer: ['Evaluate (A OR B)', 'Evaluate C', 'Evaluate (Result1 AND C)', 'Final Output'] },
            { id: 'q3', title: 'Circuit Structure', type: 'match', correctAnswer: { '1': '(A AND B) OR C', '2': 'A AND (B OR C)', '3': 'NOT (A AND B)', '4': 'NOT (A OR B)' } },
            { id: 'q4', title: 'Intermediate Values', type: 'mcq', correctAnswer: '0' },
            { id: 'q5', title: 'Logic Construction', type: 'drag', correctAnswer: { expression: ['NOT A', 'AND', 'B'] } }
        ];
        ...
        function checkAnswers() {
            ...
            if (!checkDragQuestion('q5', 'expression')) allCorrect = false;
