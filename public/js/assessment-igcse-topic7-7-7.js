/**
 * Extracted from 7.7_assessment.html on 2025-12-14
 ...
 */
        ...
        let timeTakenStr = "";
        let teacherName = "";
        const testName = "7.7 Trace Tables";
        ...
        // Q1 Data (Trace Table Purpose)
        const q1Options = [
            { value: 'To record the value of variables at each step', correct: true },
            { value: 'To write the code for the program', correct: false },
            { value: 'To speed up the computer', correct: false },
            { value: 'To design the user interface', correct: false }
        ];
        let q1Selection = null;

        // Q2 Data (Dry Run Logic)
        const q2Steps = [
            { id: 's1', text: 'Set up columns for each variable and output' },
            { id: 's2', text: 'Select a set of test data' },
            { id: 's3', text: 'Work through the algorithm step-by-step' },
            { id: 's4', text: 'Record changes in variable values in the table' },
            { id: 's5', text: 'Compare actual output with expected output' }
        ];

        // Q3 Data (Variable Tracking)
        const q3Items = [
            { id: 'i1', text: '1', correct: 'l1' },
            { id: 'i2', text: '3', correct: 'l2' },
            { id: 'i3', text: '6', correct: 'l3' },
            { id: 'i4', text: '0', correct: 'none' }, // Distractor
            { id: 'i5', text: '2', correct: 'none' }, // Distractor
            { id: 'i6', text: '4', correct: 'none' }  // Distractor
        ];

        // Q4 Data (Output Prediction)
        const q4Options = [
            { value: 'Less', correct: true },
            { value: 'More', correct: false },
            { value: '5', correct: false },
            { value: '10', correct: false }
        ];
        let q4Selection = null;

        // Q5 Data (Algorithm Analysis)
        const q5Defs = [
            { id: '1', text: 'Manual execution of an algorithm' },
            { id: '2', text: 'Records value changes' },
            { id: '3', text: 'Records what is displayed' },
            { id: '4', text: 'Input values used for the trace' }
        ];
        const q5Terms = [
            { id: '1', text: 'Dry Run' },
            { id: '2', text: 'Variable Column' },
            { id: '3', text: 'Output Column' },
            { id: '4', text: 'Test Data' }
        ];

        const questionMeta = [
            { id: 'q1', title: 'Trace Table Purpose', type: 'mcq', correctAnswer: 'To record the value of variables at each step' },
            { id: 'q2', title: 'Dry Run Logic', type: 'order', correctAnswer: ['Setup', 'Select Data', 'Work Through', 'Record', 'Compare'] },
            { id: 'q3', title: 'Variable Tracking', type: 'drag', correctAnswer: { l1: ['1'], l2: ['3'], l3: ['6'] } },
            { id: 'q4', title: 'Output Prediction', type: 'mcq', correctAnswer: 'Less' },
            { id: 'q5', title: 'Algorithm Analysis', type: 'match', correctAnswer: { '1': 'Dry Run', '2': 'Variable Column', '3': 'Output Column', '4': 'Test Data' } }
        ];
        ...
        function checkAnswers() {
            ...
            if (!checkOrderQuestion('q2', ['s1', 's2', 's3', 's4', 's5'])) allCorrect = false;
            if (!checkDragQuestion('q3', 'l1', 'l2', 'l3')) allCorrect = false;
        ...
        function checkDragQuestion(qId, ...buckets) {
            ...
            if (document.getElementById(`${qId}-source`).children.length > 3) correct = false; // Expecting 3 items left (distractors)
