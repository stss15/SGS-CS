 ...
 * IB Syllabus Reference: B4.1.2, B4.1.3
 *
 * Learning Objectives:
 * - Build Node and LinkedList classes
 * - Insert at front/end/position
 * - Delete nodes while maintaining links
 * - Traverse and search linked lists
 * - Understand tradeoffs vs arrays
 */

import { LessonSection, Challenge } from './level1_content';

// ============================================================================
// BASE CONTENT - Node chains and pointers
// ============================================================================

export const level16BaseContent: LessonSection[] = [
  {
...
def delete_at(self, position):
  ...
  {
    title: "6. When to Use Linked Lists",
    content: `Use linked lists when:
...
- You perform many searches by position`
  }
];

// ============================================================================
// CHALLENGES - 7 linked list missions
// ============================================================================
