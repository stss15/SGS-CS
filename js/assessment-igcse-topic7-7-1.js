/**
 * Extracted from 7.1_assessment.html on 2025-12-14
 ...
 */
        ...
        const q2Defs = [
            { id: '1', text: 'Removing unnecessary details' },
            { id: '2', text: 'Breaking a problem into smaller parts' },
            { id: '3', text: 'Defining exactly what is needed' }
        ];
        const q2Terms = [
            { id: '1', text: 'Abstraction' },
            { id: '2', text: 'Decomposition' },
            { id: '3', text: 'Requirements Specification' }
        ];

        // Q3 Data (Design vs Coding)
        const q3Items = [
            { id: 'd1', text: 'Flowchart', correct: 'design' },
            { id: 'd2', text: 'Pseudocode', correct: 'design' },
            { id: 'd3', text: 'Structure Chart', correct: 'design' },
            { id: 'c1', text: 'Source Code', correct: 'coding' },
            { id: 'c2', text: 'Iterative Testing', correct: 'coding' }
        ];

        // Q4 Data (MCQ)
        const q4Options = [
            { value: 'Testing modules repeatedly while writing code', correct: true },
            { value: 'Testing the final program once', correct: false },
            { value: 'Testing the hardware only', correct: false },
            { value: 'Designing the program structure', correct: false }
        ];
        let q4Selection = null;

        // Q5 Data (PDLC Definitions)
        const q5Defs = [
            { id: '1', text: 'Defining the problem and requirements' },
            { id: '2', text: 'Planning how the program will work' },
            { id: '3', text: 'Writing the program in a specific language' },
            { id: '4', text: 'Running the program with test data' }
        ];
        const q5Terms = [
            { id: '1', text: 'Analysis' },
            { id: '2', text: 'Design' },
        ...
        const questionMeta = [
            ...
            { id: 'q2', title: 'Analysis Tools', type: 'match', correctAnswer: { '1': 'Abstraction', '2': 'Decomposition', '3': 'Requirements Spec' } },
            { id: 'q3', title: 'Design vs Coding', type: 'drag', correctAnswer: { design: ['Flowchart', 'Pseudocode', 'Structure Chart'], coding: ['Source Code', 'Iterative Testing'] } },
            { id: 'q4', title: 'Iterative Testing', type: 'mcq', correctAnswer: 'Testing modules repeatedly while writing code' },
            { id: 'q5', title: 'PDLC Definitions', type: 'match', correctAnswer: { '1': 'Analysis', '2': 'Design', '3': 'Coding', '4': 'Testing' } }
        ];
        ...
        function checkAnswers() {
            ...
            if (!checkDragQuestion('q3', 'design', 'coding')) allCorrect = false;
            if (!checkMCQQuestion('q4')) allCorrect = false;
        ...
        function checkMCQQuestion(qId) {
            const correctOpt = q4Options.find(o => o.correct);
            if (q4Selection === correctOpt.value) {
                document.querySelector(`#${qId}-options .mcq-option[data-value="${q4Selection}"]`).classList.add('correct');
                markCorrect(qId);
                return true;
            } else {
                if (q4Selection) document.querySelector(`#${qId}-options .mcq-option[data-value="${q4Selection}"]`).classList.add('wrong');
                markWrong(qId);
                return false;
            }
        }
