...
| File | Topic | Status |
|------|-------|--------|
| `docs/content/ib-content/textbooks/IB Text AI/A1.html` | Computer Fundamentals | ✅ Complete |
| `docs/content/ib-content/textbooks/IB Text AI/A2.html` | Networks | ✅ Complete |
| `docs/content/ib-content/textbooks/IB Text AI/A3.html` | Databases | ⬜ Empty |
| `docs/content/ib-content/textbooks/IB Text AI/A4.html` | Machine Learning | ⬜ Empty |
| `docs/content/ib-content/textbooks/IB Text AI/B1.html` | Computational Thinking | ✅ Partial |
| `docs/content/ib-content/textbooks/IB Text AI/B2.html` | Programming | ⬜ Empty |
| `docs/content/ib-content/textbooks/IB Text AI/B3.html` | OOP | ✅ Complete |
| `docs/content/ib-content/textbooks/IB Text AI/B4.html` | ADTs (HL) | ⬜ Empty |
...
| File | Lines | Topic |
|------|-------|-------|
| `docs/content/ib-content/textbooks/A1.txt` | ~10,000 | Computer Fundamentals |
| `docs/content/ib-content/textbooks/A2.txt` | ~TBD | Networks |
| `docs/content/ib-content/textbooks/A3.txt` | ~TBD | Databases |
| `docs/content/ib-content/textbooks/A4.txt` | ~8,800 | Machine Learning |
| `docs/content/ib-content/textbooks/B1.txt` | ~800 | Computational Thinking |
| `docs/content/ib-content/textbooks/B2.txt` | ~10,500 | Programming |
| `docs/content/ib-content/textbooks/B3.txt` | ~TBD | OOP |
| `docs/content/ib-content/textbooks/B4.txt` | ~13,200 | ADTs (HL) |
...
```
docs/content/ib-content/ib/keywords/
├── A1_keywords.txt
├── A2_keywords.txt
├── A3_keywords.txt
├── A4_keywords.txt
...
1. **Read the source content**
   - Primary: `docs/content/ib-content/textbooks/IB Text AI/{{TOPIC}}.html`
   - Full: `docs/content/ib-content/textbooks/{{TOPIC}}.txt`

2. **Extract keywords** for this section
   - Add to `docs/content/ib-content/ib/keywords/{{TOPIC}}_keywords.txt`
...
```
docs/content/ib-content/textbooks/IB Text AI/A1.html  → A1.1, A1.2, A1.3, A1.4
docs/content/ib-content/textbooks/IB Text AI/A2.html  → A2.1, A2.2, A2.3, A2.4
docs/content/ib-content/textbooks/IB Text AI/B1.html  → B1.1, B1.2, B1.3, B1.4
docs/content/ib-content/textbooks/IB Text AI/B3.html  → B3.1, B3.2, B3.3
```

### Full Textbooks (For deeper detail)
```
docs/content/ib-content/textbooks/A1.txt  (~10,000 lines)
docs/content/ib-content/textbooks/A2.txt
docs/content/ib-content/textbooks/B1.txt
... etc
```
...
□ Create keyword directory: docs/content/ib-content/ib/keywords/
