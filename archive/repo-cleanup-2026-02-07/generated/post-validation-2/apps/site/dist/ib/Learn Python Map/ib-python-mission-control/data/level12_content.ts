 ...
 * IB Syllabus Reference: B3.1.1, B3.1.2, B3.1.4
 *
 * Learning Objectives:
 * - Define classes and create objects
 * - Write constructors with __init__
 * - Create attributes and methods
 * - Use dot notation to access data and behavior
 * - Build multiple objects from one blueprint
 */

import { LessonSection, Challenge } from './level1_content';

// ============================================================================
// BASE CONTENT - Class blueprints and objects
// ============================================================================

export const level12BaseContent: LessonSection[] = [
  {
...
// ============================================================================
// CHALLENGES - 7 single-class OOP missions
// ============================================================================
