...
const featurePage = ({
  ...
  body: [
    section({
      ...
      title: 'Lesson focus and expected outcome',
      intro: 'Use this as the teaching script for the live build. The code blocks show the exact file state to aim for by the end of the step.',
    ...
    section({
      ...
      title: 'Files to write in the SQL version',
      intro: 'Work through these files in this order during the SQL build.',
  ...
  },
  {
    ...
    body: [
      ...
      section({
        ...
        title: 'Field mapping and test-table examples',
        intro: 'Use these answers when students need a concrete target.',
        content: `<div class="grid-2">
          ${noteCard('Field mapping answer set', `<div class="table-wrap"><table><thead><tr><th>Field</th><th>Why it exists</th><th>Where it appears</th></tr></thead><tbody><tr><td><code>title</code></td><td>Identifies the work item</td><td>Task row and modal input</td></tr><tr><td><code>user_id</code></td><td>Links a task to one owner</td><td>Modal input, displayed later as username</td></tr><tr><td><code>priority</code></td><td>Shows urgency</td><td>Modal input and task row</td></tr><tr><td><code>due_date</code></td><td>Supports planning</td><td>Modal input and task row</td></tr><tr><td><code>status</code></td><td>Shows whether work is finished</td><td>Task row</td></tr></tbody></table></div>`) }
