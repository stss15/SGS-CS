...
2. Run `python3 public/igcse/apply_keywords.py`
...
□ ⚠️ python3 public/igcse/apply_keywords.py — MUST RUN!
...
2. **The script** (`apply_keywords.py`) finds these terms in your HTML
...
| Keyword script | `public/igcse/apply_keywords.py` |
