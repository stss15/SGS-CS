...
- [x] Verified educator guides available (`docs/content/ib/textbooks/IB Text AI/*.html`)

**Files Created:**
```
docs/content/ib/keywords/A1_keywords.txt
docs/content/ib/keywords/A2_keywords.txt
docs/content/ib/keywords/B1_keywords.txt
docs/content/ib/keywords/B3_keywords.txt
```
...
| Source | `docs/content/ib/textbooks/IB Text AI/A1.html` section 1 + `docs/content/ib/textbooks/A1.txt` (registers, buses, FDE, cores, cache, pipelining) |
...
| Keywords | 36 added to `docs/content/ib/keywords/A1_keywords.txt` |
...
**Actions:**
- Created new A3 slide deck sources using `docs/content/ib/textbooks/A3.txt` (educator guide was empty).
...
- `docs/content/ib/keywords/A3_keywords.txt` (61 keywords)
...
**Actions:**
- Created new A4 slide deck sources using `docs/content/ib/textbooks/A4.txt` (educator guide was empty).
...
- `docs/content/ib/keywords/A4_keywords.txt` (55 keywords)
...
**Actions:**
- Created new B4.1 slide deck source using `docs/content/ib/textbooks/B4.txt` (educator guide was empty).
...
- `docs/content/ib/keywords/B4_keywords.txt` (41 keywords)
- `docs/content/ib/keywords/B2_keywords.txt` (48 keywords)
...
|------|----------|--------|
| `docs/content/ib/keywords/A1_keywords.txt` | 83 | 🔄 In Progress |
| `docs/content/ib/keywords/A2_keywords.txt` | 47 | 🔄 In Progress |
| `docs/content/ib/keywords/A3_keywords.txt` | 61 | 🔄 In Progress |
| `docs/content/ib/keywords/A4_keywords.txt` | 55 | 🔄 In Progress |
| `docs/content/ib/keywords/B1_keywords.txt` | 26 | 🔄 In Progress |
| `docs/content/ib/keywords/B2_keywords.txt` | 48 | 🔄 In Progress |
| `docs/content/ib/keywords/B3_keywords.txt` | 30 | 🔄 In Progress |
| `docs/content/ib/keywords/B4_keywords.txt` | 41 | 🔄 In Progress |
