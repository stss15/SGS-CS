 ...
 * IB Syllabus Reference: B2.1.2
 *
 * Learning Objectives:
 * - Access single characters with indexing
 * - Slice substrings with start/end positions
 * - Concatenate strings and build messages
 * - Traverse strings with loops
 * - Use core string methods for cleaning and searching
...
// ============================================================================
// BASE CONTENT - Working with text data
// ============================================================================

export const level4BaseContent: LessonSection[] = [
  {
...
// ============================================================================
// CHALLENGES - 8 text processing missions
// ============================================================================

export const level4Challenges: Challenge[] = [
  {
    id: 1,
    title: "Signal Decode",
