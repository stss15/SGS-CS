...
| **Challenge Count** | 5 |
| **Prerequisites** | Level 12 (Single Class OOP) |
...
1. Distinguish between static (class) and instance variables
2. Understand the private attribute convention (`_name`)
3. Implement getter methods to read private attributes
4. Implement setter methods with validation
5. Apply encapsulation to protect object state
6. Design classes with controlled access to internal data
...
### Building On:
- Now we PROTECT attributes
- Control HOW they're accessed and modified
- Add validation to maintain integrity

---

## Base Content Sections

### Section 1: Why Encapsulation?
...
### Section 2: Static vs Instance Variables
...
### Section 3: Private Attribute Convention
...
### Section 6: Full Encapsulation Example
...
### Challenge 4: Complete Encapsulation
...
### Challenge 5: Secure Spacecraft System
...
1. **`data/level13_content.ts`** - Create with content above
2. **`data/roadmap.ts`** - Update Level 13 tasks:
```typescript
{
  id: 13,
  title: "Encapsulation & Scope",
...
|-----------|------------|
| 1 | Total: 5 spacecraft |
| 2 | Password verification works |
| 3 | Fuel validation messages |
| 4 | Lock prevents changes |
| 5 | Full secure spacecraft operations |

---

*Level 13 Plan - Version 1.0*
